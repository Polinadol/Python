...
#     tarif= int(input('Введите ставку:   '))
#     bonus= int(input('Введите размер премии:  '))
#     return bonus+(time*tarif)
#print(f'Итого зарплата: {zarplata()}')
...
#spisok = [i for i in range(20,240) if i%20==0 or i%21==0]
#print(spisok)
...
#i=0
#for x in cycle([2,5,9,7,5,3,6,0]):
#    if i>10:
#        break
#    print(x)
#    i=1+i
...
# for el in fact(n). Она отвечает за получение факториала числа. В цикле нужно выводить
